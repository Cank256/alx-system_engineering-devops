#!/usr/bin/python3
"""
Module to count and print occurrences of keywords in hot article titles of a subreddit.
"""
import requests
...
def count_words(subreddit, word_list, counts={}, after=""):
    ...
    url = f"https://www.reddit.com/r/{subreddit}/hot.json?after={after}&limit=100"
    headers = {'User-Agent': 'python3:alx-system_engineering-devops:v1.0.0 (by /u/yourusername)'}
